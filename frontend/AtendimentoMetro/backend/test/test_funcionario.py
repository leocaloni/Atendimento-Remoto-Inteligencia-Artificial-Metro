...
if __name__ == "__main__":
    # Agora, você pode cadastrar um funcionário diretamente chamando a função:
    test_cadastrar_funcionario()  # Realiza o cadastro do funcionário

    # Outros testes podem ser chamados da mesma forma:
    # test_autenticar_funcionario()
    # test_buscar_funcionario()
    # test_atualizar_funcionario()
    # test_deletar_funcionario()
